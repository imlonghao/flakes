...
step ssh certificate --ca-url https://ca.esd.cc --root /nix/store/xdx1wynn4j76qz2pl7jzk415rpxxgzza-ca.crt --host --sign "$target" "$MYTMPDIR/ssh_host_ed25519_key.pub"
