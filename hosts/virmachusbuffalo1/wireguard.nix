...

{
  ...
  networking.wireguard.interfaces = {
    wg64719 = {
      ips = [ "fe80::1888/64" ];
      postSetup = [
        "${pkgs.iproute2}/bin/ip addr add 172.22.68.0/32 peer 172.22.119.10/32 dev wg64719"
        "${pkgs.iproute2}/bin/ip route change 172.22.119.10 src 172.22.68.1 dev wg64719"
      ];
