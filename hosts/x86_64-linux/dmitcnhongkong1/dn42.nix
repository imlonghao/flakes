  ...
  dn42 = {
    ...
    peers = [
      ...
      }
      {
        name = "wg0028";
        listen = 20028;
        endpoint = "hkg1.edge.ngworks.org:51800";
        publickey = "Q9kncPFCcdOKxfcP6ai2rg3QlwVVnp4W5TahwlY3RBc=";
        asn = 4242420028;
        e6 = "fe80::28";
      }
      {
        ...
        e6 = "fe80::78";
        listen = 20078;
        endpoint = "hk01.tes286.top:21888";
      ...
      }
      {
        name = "wg1810";
        listen = 21810;
        endpoint = "hk42.sabrinaishere.party:21888";
        publickey = "Q09qYo+am/qkseqy/Q5nrb+jtMAeTgHsVZ+er/cypXw=";
        asn = 4242421810;
        e6 = "fe80::1810";
      }
      {
      ...
      }
      {
        ...
        e6 = "fe80::2921";
        listen = 22921;
        endpoint = "154.37.219.205:21888";
        publickey = "c7Nx4qyVnIHAzV/VUn4wdiyNFMF84Vhsblk1UyCUqD8=";
      }
      {
        name = "wg2923";
        asn = 4242422923;
      ...
      }
      {
        ...
        e6 = "fe80::3729";
        listen = 23729;
        endpoint = "hkg1.pixiainfra.pixia.eu.org:21888";
        publickey = "ycv1p8vlGzfV/LMEEvfmE+hcKmOHMokKMr85yFBaNR0=";
      }
      {
        name = "wg3777";
        asn = 4242423777;
        e6 = "fe80::3777";
        listen = 23777;
        endpoint = "hk.dn42.cloudc.dev:23777";
        publickey = "ZynDjBdOWAS1YjZzwdiSI4kbthisE2xgPiOHopdfIxQ=";
      }
      {
        name = "wg3797";
        listen = 23797;
