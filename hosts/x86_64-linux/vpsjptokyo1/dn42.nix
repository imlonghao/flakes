  ...
  dn42 = {
    ...
    peers = [
      ...
      }
      {
        name = "wg0998";
        listen = 20998;
        endpoint = "jp1.dn42.moenet.work:31888";
        publickey = "OkZGn8FGwUNuC9pt3kYIFeDNIx/wsGGEWikfOsBDFl8=";
        presharedkey = "ObCCkhk8QbD3SKpqM55sJw2fq9AiBqqrN8pAZRzM6dk=";
        asn = 4242420998;
        e6 = "fe80::998:101:1:1";
      }
      {
      ...
      }
      {
        ...
        publickey = "TRsJBPvVUXBCDuiBDwte+YCbkjkIglfVm+M5NxOFfwk=";
      }
      {
        name = "wg3797";
        listen = 23797;
      ...
      }
      {
        ...
        publickey = "Bh8/7a6H2u3VOxsA8o81FYpKUgXRJYajFQjE+PwuXlE=";
      }
      {
        name = "wg3997";
        asn = 4242423997;
