...

{
  users.users = {
    ...
    cloudiplcuslosangeles1 = {
      ...
      isNormalUser = true;
      openssh.authorizedKeys.keys = [
        ''command="${pkgs.borgbackup}/bin/borg serve --restrict-to-repository /persist/borg/vpsjptokyo1/repo --append-only",restrict ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOd9q7yYhjYQcxiSmybWtbHYa/cnwK/uz/fYP4mVV0AH root@cloudiplcuslosangeles1''
      ];
    };
  };
}
