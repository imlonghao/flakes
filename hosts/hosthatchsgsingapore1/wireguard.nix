...
in
{
  networking.wireguard.interfaces = {
    wg0588 = {
      ips = [ "fe80::1888/64" ];
      postSetup = "${pkgs.iproute2}/bin/ip addr add 172.22.68.0/32 peer 172.23.110.69/32 dev wg0588";
      privateKey = wgPrivKey;
      listenPort = 20588;
      allowedIPsAsRoutes = false;
      peers = [
        {
          endpoint = "sgp.l.x6c.us:21888";
          publicKey = "nDPy+99y/BORsbpLWA36jRjs0YKwSCjZWion+RZDNQg=";
