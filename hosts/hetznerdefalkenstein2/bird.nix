{ ... }:
{
  services.bird2 = {
    ...
    config = ''
      ...
      protocol bgp AS4242420345 from dnpeers {
        neighbor fe80::345 % 'wg0345' as 4242420345;
      }
      ...
      protocol bgp AS4242421078 from dnpeers {
        neighbor fe80::1078 % 'wg1078' as 4242421078;
      }
      ...
      protocol bgp AS4242422117 from dnpeers {
        neighbor fe80::2117 % 'wg2117' as 4242422117;
      }
