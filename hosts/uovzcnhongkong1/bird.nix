{ ... }:
{
  services.bird2 = {
    ...
    config = ''
      ...
      protocol bgp AS4242420508 from dnpeers {
        neighbor fe80::0508 % 'wg0508' as 4242420508;
      }
      ...
      protocol bgp AS4242423632v4 from dnpeers {
        neighbor 172.23.36.34 as 4242423632;
      }
      protocol bgp AS4242423632v6 from dnpeers {
