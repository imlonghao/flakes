{ ... }:
{
  services.bird2 = {
    ...
    config = ''
      ...
      protocol bgp AS4242422398 from dnpeers {
        neighbor fe80::2399:1 % 'wg2398' as 4242422398;
      }
      protocol bgp AS4242422399 from dnpeers {
        neighbor fe80::adc5 % 'wg2399' as 4242422399;
      }
